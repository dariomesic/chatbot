<template>
  <div class="header">
    ...
    <div style="display: flex">
      <span v-show="disableSaveButton" class="animated-text"
        ><svg
          height="20"
          width="20"
          version="1.1"
      ...
      <div></div>
      <button @click="$router.push('/intents')" tabindex="0" type="button">
        <svg
          focusable="false"
          preserveAspectRatio="xMidYMid meet"
          xmlns="http://www.w3.org/2000/svg"
...
.animated-text {
  ...
  margin-right: 15px;
  font-weight: bold;
  background: linear-gradient(to right, #0a4f91, #00264d);
